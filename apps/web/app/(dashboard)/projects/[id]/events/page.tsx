        ...
        {!events.data ? (
          <div className="flex flex-col items-center gap-3 px-6 py-16 text-center">
            ...
            <p className="text-xs text-gray-500">
              Send your first event to see the delivery pipeline
            </p>
          </div>
        ) : (
            ...
            <table className="w-full text-left text-sm">
              <thead>
                <tr className="border-b border-gray-100 bg-gray-50/50">
                  ...
                  <th className="hidden px-5 py-3 text-xs font-medium uppercase tracking-wider text-gray-500 lg:table-cell">
                    Received
                  </th>
                </tr>
              </thead>
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-5 py-3.5">
                        {lastLog ? (
                          <span
                            className={`inline-flex items-center gap-1.5 rounded-full px-2 py-0.5 text-xs font-medium ${statusStyles[lastLog.status]}`}
                          >
                            <span
                      ...
                      <td className="hidden px-5 py-3.5 md:table-cell">
                        {lastLog ? (
                          <span
                            className={`inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium capitalize ${channelStyles[lastLog.channel]}`}
                          >
                            {lastLog.channel}
                            {e.logs.length > 1 && (
                      ...
                      <td className="hidden whitespace-nowrap px-5 py-3.5 text-xs tabular-nums text-gray-500 lg:table-cell">
                        {e.received_at
